                                            ...
                                            <div class="card">
                                                ...
                                                @method('PUT')
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="IP" value="{{$find_server_id->IP}}" name="ip">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Server Name</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Servername" value="{{$find_server_id->server_name}}" name = "servername">
                                                            </div>
                                                        </div>
